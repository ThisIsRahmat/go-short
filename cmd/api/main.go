...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", "postgres://go_short:secret@localhost/go_short?sslmode=disable", "PostgreSQL DSN")
	...
	//this parses all the command line flags and must be called after all the flags are defined
	flag.Parse()
